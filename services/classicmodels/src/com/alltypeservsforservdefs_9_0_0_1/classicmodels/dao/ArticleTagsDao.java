...
/**
 * Specifies methods used to obtain and modify ArticleTags related information
 * which is stored in the database.
 */
@Repository("classicmodels.ArticleTagsDao")
public class ArticleTagsDao extends WMGenericDaoImpl<ArticleTags, ArticleTagsId> {
