...
import com.alltypeservsforservdefs_9_0_0_1.classicmodels.Employees;
import com.alltypeservsforservdefs_9_0_0_1.classicmodels.service.EmployeesService;
 ...
 * @see Employees
 */
@RestController("classicmodels.EmployeesController")
...
public Employees createEmployees(@RequestBody Employees employees) {
    ...
    @RequestMapping(value="/{id:.+}/employeesesForReportsToRelation", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the employeesesForReportsToRelation instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Employees> findAssociatedEmployeesesForReportsToRelation(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated employeesesForReportsToRelation");
        return employeesService.findAssociatedEmployeesesForReportsToRelation(id, pageable);
    }
