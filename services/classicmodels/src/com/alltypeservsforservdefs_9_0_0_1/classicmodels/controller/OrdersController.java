...
import com.alltypeservsforservdefs_9_0_0_1.classicmodels.service.OrdersService;
...
public Orders createOrders(@RequestBody Orders orders) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Orderdetails> findAssociatedOrderdetailses(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated orderdetailses");
        return ordersService.findAssociatedOrderdetailses(id, pageable);
    }
