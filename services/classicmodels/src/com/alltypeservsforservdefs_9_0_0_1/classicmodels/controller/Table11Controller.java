...
import com.alltypeservsforservdefs_9_0_0_1.classicmodels.service.Table11Service;
...
public Table11 createTable11(@RequestBody Table11 table11) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table11 getTable11(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table11 editTable11(@PathVariable("id") Integer id, @RequestBody Table11 table11) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTable11(@PathVariable("id") Integer id) throws EntityNotFoundException {
