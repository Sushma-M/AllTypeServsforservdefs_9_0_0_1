...
import com.alltypeservsforservdefs_9_0_0_1.classicmodels.service.ArticleTagssxService;
...
@ApiOperation(value = "Returns the ArticleTagssx instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ArticleTagssx getArticleTagssx(@RequestParam("articleId") Integer articleId,@RequestParam("tagId") Integer tagId,@RequestParam("blank") String blank) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ArticleTagssx editArticleTagssx(@RequestParam("articleId") Integer articleId,@RequestParam("tagId") Integer tagId,@RequestParam("blank") String blank, @RequestBody ArticleTagssx articleTagssx) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteArticleTagssx(@RequestParam("articleId") Integer articleId,@RequestParam("tagId") Integer tagId,@RequestParam("blank") String blank) throws EntityNotFoundException {
    ...
    public Page<ArticleTagssx> searchArticleTagssxesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering ArticleTagssxes list");
