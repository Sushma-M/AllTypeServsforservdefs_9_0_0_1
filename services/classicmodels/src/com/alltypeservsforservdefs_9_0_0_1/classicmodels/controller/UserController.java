...
import com.alltypeservsforservdefs_9_0_0_1.classicmodels.service.UserService;
 ...
 * @see User
 */
@RestController("classicmodels.UserController")
@Api(value = "UserController", description = "Exposes APIs to work with User resource.")
@RequestMapping("/classicmodels/User")
public class UserController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserController.class);

    @Autowired
	@Qualifier("classicmodels.UserService")
