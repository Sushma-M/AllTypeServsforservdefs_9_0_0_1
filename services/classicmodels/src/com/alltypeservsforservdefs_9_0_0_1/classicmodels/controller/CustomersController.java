...
import com.alltypeservsforservdefs_9_0_0_1.classicmodels.service.CustomersService;
...
public Customers createCustomers(@RequestBody Customers customers) {
    ...
    @RequestMapping(value="/{id:.+}/ordersesForCustomerNumber", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the ordersesForCustomerNumber instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Orders> findAssociatedOrdersesForCustomerNumber(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated ordersesForCustomerNumber");
        return customersService.findAssociatedOrdersesForCustomerNumber(id, pageable);
    }

    @RequestMapping(value="/{id:.+}/ordersesForCustomerNumberRelation", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the ordersesForCustomerNumberRelation instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Orders> findAssociatedOrdersesForCustomerNumberRelation(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated ordersesForCustomerNumberRelation");
        return customersService.findAssociatedOrdersesForCustomerNumberRelation(id, pageable);
    }

    @RequestMapping(value="/{id:.+}/paymentsesForCustomerNumber", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the paymentsesForCustomerNumber instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Payments> findAssociatedPaymentsesForCustomerNumber(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated paymentsesForCustomerNumber");
        return customersService.findAssociatedPaymentsesForCustomerNumber(id, pageable);
    }

    @RequestMapping(value="/{id:.+}/paymentsesForCustomerNumberRelation", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the paymentsesForCustomerNumberRelation instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Payments> findAssociatedPaymentsesForCustomerNumberRelation(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated paymentsesForCustomerNumberRelation");
        return customersService.findAssociatedPaymentsesForCustomerNumberRelation(id, pageable);
    }
