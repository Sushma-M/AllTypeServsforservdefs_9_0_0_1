...
public Productlines createProductlines(@RequestPart("wm_data_json") Productlines productlines, @RequestPart(value = "image", required = false) MultipartFile _image) {
    ...
    @RequestMapping(value="/{id:.+}/productsesForProductLine", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the productsesForProductLine instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Products> findAssociatedProductsesForProductLine(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated productsesForProductLine");
        return productlinesService.findAssociatedProductsesForProductLine(id, pageable);
    }

    @RequestMapping(value="/{id:.+}/productsesForProductLineRelation", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the productsesForProductLineRelation instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Products> findAssociatedProductsesForProductLineRelation(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated productsesForProductLineRelation");
        return productlinesService.findAssociatedProductsesForProductLineRelation(id, pageable);
    }
