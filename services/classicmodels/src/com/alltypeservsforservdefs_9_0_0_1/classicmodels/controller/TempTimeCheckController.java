...
import com.alltypeservsforservdefs_9_0_0_1.classicmodels.service.TempTimeCheckService;
...
public TempTimeCheck createTempTimeCheck(@RequestBody TempTimeCheck tempTimeCheck) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TempTimeCheck getTempTimeCheck(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TempTimeCheck editTempTimeCheck(@PathVariable("id") Integer id, @RequestBody TempTimeCheck tempTimeCheck) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTempTimeCheck(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    public Page<TempTimeCheck> searchTempTimeChecksByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering TempTimeChecks list");
