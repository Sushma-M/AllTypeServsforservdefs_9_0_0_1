...
import com.alltypeservsforservdefs_9_0_0_1.classicmodels.service.Mytable2Service;
...
@ApiOperation(value = "Returns the Mytable2 instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Mytable2 getMytable2(@RequestParam("col1") Integer col1,@RequestParam("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Mytable2 editMytable2(@RequestParam("col1") Integer col1,@RequestParam("id") Integer id, @RequestBody Mytable2 mytable2) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteMytable2(@RequestParam("col1") Integer col1,@RequestParam("id") Integer id) throws EntityNotFoundException {
    ...
    @ApiOperation(value = "Returns the paginated list of Mytable2 instances matching the optional query (q) request param. If there is no query provided, it returns all the instances. Pagination & Sorting parameters such as page& size, sort can be sent as request parameters. The sort value should be a comma separated list of field names & optional sort order to sort the data on. eg: field1 asc, field2 desc etc ")
    ...
    @ApiOperation(value = "Returns the paginated list of Mytable2 instances matching the optional query (q) request param. This API should be used only if the query string is too big to fit in GET request with request param. The request has to made in application/x-www-form-urlencoded format.")
    @RequestMapping(value="/filter", method = RequestMethod.POST, consumes= "application/x-www-form-urlencoded")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Mytable2> filterMytable2s(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Mytable2s list");
        return mytable2Service.findAll(query, pageable);
    }
	...
	@ApiOperation(value = "Returns the total count of Mytable2 instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
	public Page<Map<String, Object>> getMytable2AggregatedValues(@RequestBody AggregationInfo aggregationInfo, Pageable pageable) {
        LOGGER.debug("Fetching aggregated results for {}", aggregationInfo);
        return mytable2Service.getAggregatedValues(aggregationInfo, pageable);
    }
