...
import com.alltypeservsforservdefs_9_0_0_1.classicmodels.service.ProductsService;
 ...
 * @see Products
 */
@RestController("classicmodels.ProductsController")
...
public Products createProducts(@RequestBody Products products) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Products editProducts(@PathVariable("id") String id, @RequestBody Products products) throws EntityNotFoundException {
        LOGGER.debug("Editing Products with id: {}" , products.getProductCode());

        products.setProductCode(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteProducts(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    @RequestMapping(value="/{id:.+}/orderdetailsesForProductCode", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the orderdetailsesForProductCode instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Orderdetails> findAssociatedOrderdetailsesForProductCode(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated orderdetailsesForProductCode");
        return productsService.findAssociatedOrderdetailsesForProductCode(id, pageable);
    }

    @RequestMapping(value="/{id:.+}/orderdetailsesForProductCodeRelation", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the orderdetailsesForProductCodeRelation instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Orderdetails> findAssociatedOrderdetailsesForProductCodeRelation(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated orderdetailsesForProductCodeRelation");
        return productsService.findAssociatedOrderdetailsesForProductCodeRelation(id, pageable);
    }
