...
import com.alltypeservsforservdefs_9_0_0_1.classicmodels.service.PaymentsService;
...
@ApiOperation(value = "Returns the Payments instance associated with the given composite-id.")
	...
	@ApiOperation(value = "Returns the total count of Payments instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
	public Page<Map<String, Object>> getPaymentsAggregatedValues(@RequestBody AggregationInfo aggregationInfo, Pageable pageable) {
        LOGGER.debug("Fetching aggregated results for {}", aggregationInfo);
        return paymentsService.getAggregatedValues(aggregationInfo, pageable);
    }
