...
public interface ProductsService {
    ...
    /*
     * Returns the associated orderdetailsesForProductCode for given Products id.
     *
     ...
     * @see Page
     */
    Page<Orderdetails> findAssociatedOrderdetailsesForProductCode(String productCode, Pageable pageable);

    /*
     * Returns the associated orderdetailsesForProductCodeRelation for given Products id.
     *
     * @param productCode value of productCode; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Orderdetails instances.
     ...
     * @see Page
     */
    Page<Orderdetails> findAssociatedOrderdetailsesForProductCodeRelation(String productCode, Pageable pageable);
