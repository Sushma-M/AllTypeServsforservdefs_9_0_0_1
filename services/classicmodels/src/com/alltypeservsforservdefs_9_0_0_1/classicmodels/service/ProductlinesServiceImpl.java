...
public class ProductlinesServiceImpl implements ProductlinesService {
	...
	public Productlines create(Productlines productlines) {
        ...
        if(productlinesCreated.getProductsesForProductLine() != null) {
            for(Products productsesForProductLine : productlinesCreated.getProductsesForProductLine()) {
                productsesForProductLine.setProductlinesByProductLine(productlinesCreated);
                LOGGER.debug("Creating a new child Products with information: {}", productsesForProductLine);
                productsService.create(productsesForProductLine);
            }
        }

        if(productlinesCreated.getProductsesForProductLineRelation() != null) {
            for(Products productsesForProductLineRelation : productlinesCreated.getProductsesForProductLineRelation()) {
                productsesForProductLineRelation.setProductlinesByProductLineRelation(productlinesCreated);
                LOGGER.debug("Creating a new child Products with information: {}", productsesForProductLineRelation);
                productsService.create(productsesForProductLineRelation);
            }
        }
