...
import com.alltypeservsforservdefs_9_0_0_1.classicmodels.User;
 ...
 * @see User
 */
@Service("classicmodels.UserService")
@Validated
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    @Qualifier("classicmodels.UserDao")
	...
	public User update(User user) throws EntityNotFoundException {
        ...
        Integer userIdInstance = user.getId();
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service classicmodels for table User to {} format", exportType);
