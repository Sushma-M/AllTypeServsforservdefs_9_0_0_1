...
public interface EmployeesService {
	 ...
	 */
	Employees update(@Valid Employees employees) throws EntityNotFoundException;
    ...
    /*
     * Returns the associated employeesesForReportsToRelation for given Employees id.
     *
     * @param employeeNumber value of employeeNumber; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Employees instances.
     ...
     * @see Page
     */
    Page<Employees> findAssociatedEmployeesesForReportsToRelation(Integer employeeNumber, Pageable pageable);
