...
public interface ProductlinesService {
	 ...
	 */
	Productlines update(@Valid Productlines productlines) throws EntityNotFoundException;
    ...
    /*
     * Returns the associated productsesForProductLine for given Productlines id.
     *
     ...
     * @see Page
     */
    Page<Products> findAssociatedProductsesForProductLine(String productLine, Pageable pageable);

    /*
     * Returns the associated productsesForProductLineRelation for given Productlines id.
     *
     * @param productLine value of productLine; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Products instances.
     ...
     * @see Page
     */
    Page<Products> findAssociatedProductsesForProductLineRelation(String productLine, Pageable pageable);
