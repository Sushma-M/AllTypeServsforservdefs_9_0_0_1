...
public interface CustomersService {
    ...
    /*
     * Returns the associated ordersesForCustomerNumber for given Customers id.
     *
     ...
     * @see Page
     */
    Page<Orders> findAssociatedOrdersesForCustomerNumber(Integer customerNumber, Pageable pageable);

    /*
     * Returns the associated ordersesForCustomerNumberRelation for given Customers id.
     *
     * @param customerNumber value of customerNumber; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Orders instances.
     ...
     * @see Page
     */
    Page<Orders> findAssociatedOrdersesForCustomerNumberRelation(Integer customerNumber, Pageable pageable);

    /*
     * Returns the associated paymentsesForCustomerNumber for given Customers id.
     *
     * @param customerNumber value of customerNumber; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<Payments> findAssociatedPaymentsesForCustomerNumber(Integer customerNumber, Pageable pageable);

    /*
     * Returns the associated paymentsesForCustomerNumberRelation for given Customers id.
     *
     * @param customerNumber value of customerNumber; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Payments instances.
     ...
     * @see Page
     */
    Page<Payments> findAssociatedPaymentsesForCustomerNumberRelation(Integer customerNumber, Pageable pageable);
