...
public class ShiftServiceImpl implements ShiftService {
	...
	@Override
	public Shift getById(Byte shiftIdInstance) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "AdventureWorks2014TransactionManager")
	@Override
	public Shift findById(Byte shiftIdInstance) {
        LOGGER.debug("Finding Shift by id: {}", shiftIdInstance);
    ...
    @Transactional(readOnly = true, value = "AdventureWorks2014TransactionManager")
    @Override
    public Shift getByStartTimeAndEndTime(Date startTime, Date endTime) {
	...
	public Shift update(Shift shift) throws EntityNotFoundException {
        ...
        Byte shiftIdInstance = shift.getShiftId();
    ...
    @Transactional(value = "AdventureWorks2014TransactionManager")
	@Override
	public Shift delete(Byte shiftIdInstance) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "AdventureWorks2014TransactionManager")
    @Override
    public Page<EmployeeDepartmentHistory> findAssociatedEmployeeDepartmentHistories(Byte shiftId, Pageable pageable) {
