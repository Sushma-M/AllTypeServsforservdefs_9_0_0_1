...
import com.testsoapshare.adventureworks2014.EmployeePayHistory;
import com.testsoapshare.adventureworks2014.JobCandidate;
...
public interface EmployeeService {
	 ...
	 *
	 * @param nationalIdnumber value of nationalIdnumber; value cannot be null.
	 * @return Employee associated with the given inputs.
     * @throws EntityNotFoundException if no matching Employee found.
	 */
    Employee getByNationalIdnumber(String nationalIdnumber)throws EntityNotFoundException;
    ...
    /*
     * Returns the associated employeePayHistories for given Employee id.
     *
     * @param businessEntityId value of businessEntityId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated EmployeePayHistory instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<EmployeePayHistory> findAssociatedEmployeePayHistories(Integer businessEntityId, Pageable pageable);

    /*
     * Returns the associated jobCandidates for given Employee id.
     *
     * @param businessEntityId value of businessEntityId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated JobCandidate instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<JobCandidate> findAssociatedJobCandidates(Integer businessEntityId, Pageable pageable);

    /*
     * Returns the associated employeeDepartmentHistories for given Employee id.
     *
     * @param businessEntityId value of businessEntityId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<EmployeeDepartmentHistory> findAssociatedEmployeeDepartmentHistories(Integer businessEntityId, Pageable pageable);
