...
import com.testsoapshare.adventureworks2014.Department;
...
public interface DepartmentService {
	 ...
	 *
	 * @param departmentIdInstance The id of the Department to get; value cannot be null.
	 * @return Department associated with the given departmentIdInstance.
     * @throws EntityNotFoundException If no Department is found.
	 */
	Department getById(Short departmentIdInstance) throws EntityNotFoundException;
	 ...
	 * @return Department associated with the given departmentIdInstance.
	 */
	Department findById(Short departmentIdInstance);

    /**
	 * Find and return the Department for given name  if exists.
	 *
	 ...
	 */
    Department getByName(String name)throws EntityNotFoundException;
	 ...
	 *
	 * @param departmentIdInstance The id of the Department to be deleted; value cannot be null.
	 * @return The deleted Department.
	 * @throws EntityNotFoundException if no Department found with the given id.
	 */
	Department delete(Short departmentIdInstance) throws EntityNotFoundException;
    ...
    /*
     * Returns the associated employeeDepartmentHistories for given Department id.
     *
     ...
     * @see Page
     */
    Page<EmployeeDepartmentHistory> findAssociatedEmployeeDepartmentHistories(Short departmentId, Pageable pageable);
