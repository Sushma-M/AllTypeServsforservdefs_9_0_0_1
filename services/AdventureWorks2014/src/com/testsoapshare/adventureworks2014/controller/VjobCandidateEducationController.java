...
import com.testsoapshare.adventureworks2014.VjobCandidateEducation;
import com.testsoapshare.adventureworks2014.VjobCandidateEducationId;
import com.testsoapshare.adventureworks2014.service.VjobCandidateEducationService;
...
@ApiOperation(value = "Returns the VjobCandidateEducation instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteVjobCandidateEducation(@RequestParam("jobCandidateId") Integer jobCandidateId,@RequestParam("edu_level") String edu_level,@RequestParam("edu_startDate") Timestamp edu_startDate,@RequestParam("edu_endDate") Timestamp edu_endDate,@RequestParam("edu_degree") String edu_degree,@RequestParam("edu_major") String edu_major,@RequestParam("edu_minor") String edu_minor,@RequestParam("edu_gpa") String edu_gpa,@RequestParam("edu_gpascale") String edu_gpascale,@RequestParam("edu_school") String edu_school,@RequestParam("edu_loc_countryRegion") String edu_loc_countryRegion,@RequestParam("edu_loc_state") String edu_loc_state,@RequestParam("edu_loc_city") String edu_loc_city) throws EntityNotFoundException {
