...
import com.testsoapshare.adventureworks2014.EmployeePayHistoryId;
import com.testsoapshare.adventureworks2014.service.EmployeePayHistoryService;
...
@ApiOperation(value = "Returns the EmployeePayHistory instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeePayHistory getEmployeePayHistory(@RequestParam("businessEntityId") Integer businessEntityId,@RequestParam("rateChangeDate") Timestamp rateChangeDate) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeePayHistory editEmployeePayHistory(@RequestParam("businessEntityId") Integer businessEntityId,@RequestParam("rateChangeDate") Timestamp rateChangeDate, @RequestBody EmployeePayHistory employeePayHistory) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteEmployeePayHistory(@RequestParam("businessEntityId") Integer businessEntityId,@RequestParam("rateChangeDate") Timestamp rateChangeDate) throws EntityNotFoundException {
