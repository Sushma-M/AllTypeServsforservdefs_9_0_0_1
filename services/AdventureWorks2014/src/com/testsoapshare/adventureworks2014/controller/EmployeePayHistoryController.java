...
public class EmployeePayHistoryController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeePayHistory getEmployeePayHistory(@RequestParam("businessEntityId") Integer businessEntityId, @RequestParam("rateChangeDate") Date rateChangeDate) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeePayHistory editEmployeePayHistory(@RequestParam("businessEntityId") Integer businessEntityId, @RequestParam("rateChangeDate") Date rateChangeDate, @RequestBody EmployeePayHistory employeePayHistory) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteEmployeePayHistory(@RequestParam("businessEntityId") Integer businessEntityId, @RequestParam("rateChangeDate") Date rateChangeDate) throws EntityNotFoundException {
        EmployeePayHistoryId employeepayhistoryId = new EmployeePayHistoryId();
        employeepayhistoryId.setBusinessEntityId(businessEntityId);
        employeepayhistoryId.setRateChangeDate(rateChangeDate);
