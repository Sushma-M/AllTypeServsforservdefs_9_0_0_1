...
import com.testsoapshare.adventureworks2014.EmployeeDepartmentHistoryId;
import com.testsoapshare.adventureworks2014.service.EmployeeDepartmentHistoryService;
...
@ApiOperation(value = "Returns the EmployeeDepartmentHistory instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeeDepartmentHistory getEmployeeDepartmentHistory(@RequestParam("businessEntityId") Integer businessEntityId,@RequestParam("startDate") Date startDate,@RequestParam("departmentId") Short departmentId,@RequestParam("shiftId") Byte shiftId) throws EntityNotFoundException {
