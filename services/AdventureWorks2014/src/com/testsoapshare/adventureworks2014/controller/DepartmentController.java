...
import com.testsoapshare.adventureworks2014.service.DepartmentService;
 ...
 * @see Department
 */
@RestController("AdventureWorks2014.DepartmentController")
@Api(value = "DepartmentController", description = "Exposes APIs to work with Department resource.")
@RequestMapping("/AdventureWorks2014/Department")
public class DepartmentController {

    private static final Logger LOGGER = LoggerFactory.getLogger(DepartmentController.class);

    @Autowired
	@Qualifier("AdventureWorks2014.DepartmentService")
...
public Department createDepartment(@RequestBody Department department) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Department getDepartment(@PathVariable("id") Short id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Department editDepartment(@PathVariable("id") Short id, @RequestBody Department department) throws EntityNotFoundException {
        LOGGER.debug("Editing Department with id: {}" , department.getDepartmentId());
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteDepartment(@PathVariable("id") Short id) throws EntityNotFoundException {
    ...
    public Department getByName(@PathVariable("name") String name) {
        LOGGER.debug("Getting Department with uniques key Name");
    ...
    public Page<EmployeeDepartmentHistory> findAssociatedEmployeeDepartmentHistories(@PathVariable("id") Short id, Pageable pageable) {
        ...
        return departmentService.findAssociatedEmployeeDepartmentHistories(id, pageable);
    }
