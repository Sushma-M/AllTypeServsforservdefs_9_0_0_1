...
import com.testsoapshare.adventureworks2014.service.AdventureWorks2014ProcedureExecutorService_V1;
...
public class ProcedureExecutionController {
    ...
    @Autowired
    private AdventureWorks2014ProcedureExecutorService_V1 procedureService;

    @ApiOperation(value = "Process request to execute Procedure")
    @RequestMapping(value = "/procedure/execute/proc1", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public List<Object> executeProc1(@RequestParam(value = "Id", required = false) java.lang.Integer Id) throws QueryParameterMismatchException {
        LOGGER.debug("Executing named procedure proc1");
        List<Object> result = procedureService.executeProc1(Id);
