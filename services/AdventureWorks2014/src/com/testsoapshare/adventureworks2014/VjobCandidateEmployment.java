...
public class VjobCandidateEmployment implements Serializable {
    ...
    @Id
    @Column(name = "`Emp.OrgName`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Emp.JobTitle`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Emp.Responsibility`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Emp.FunctionCategory`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Emp.IndustryCategory`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Emp.Loc.CountryRegion`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Emp.Loc.State`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Emp.Loc.City`", nullable = true, length = 255)
