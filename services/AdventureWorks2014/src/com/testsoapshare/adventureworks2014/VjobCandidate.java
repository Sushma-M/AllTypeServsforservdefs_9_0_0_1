...
public class VjobCandidate implements Serializable {
    ...
    @Id
    @Column(name = "`Name.Prefix`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Name.First`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Name.Middle`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Name.Last`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Name.Suffix`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Addr.Type`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Addr.Loc.CountryRegion`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Addr.Loc.State`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Addr.Loc.City`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Addr.PostalCode`", nullable = true, length = 255)
