...
/**
 * VjobCandidate generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`vJobCandidate`")
@IdClass(VjobCandidateId.class)
public class VjobCandidate implements Serializable {
    ...
    @Id
    @Column(name = "`Name.Prefix`", nullable = true, length = 30)
    ...
    @Id
    @Column(name = "`Name.First`", nullable = true, length = 30)
    ...
    @Id
    @Column(name = "`Name.Middle`", nullable = true, length = 30)
    ...
    @Id
    @Column(name = "`Name.Last`", nullable = true, length = 30)
    ...
    @Id
    @Column(name = "`Name.Suffix`", nullable = true, length = 30)
    ...
    @Id
    @Column(name = "`Skills`", nullable = true, length = 2147483647)
    ...
    @Id
    @Column(name = "`Addr.Type`", nullable = true, length = 30)
    ...
    @Id
    @Column(name = "`Addr.Loc.CountryRegion`", nullable = true, length = 100)
    ...
    @Id
    @Column(name = "`Addr.Loc.State`", nullable = true, length = 100)
    ...
    @Id
    @Column(name = "`Addr.Loc.City`", nullable = true, length = 100)
    ...
    @Id
    @Column(name = "`Addr.PostalCode`", nullable = true, length = 20)
    ...
    @Id
    @Column(name = "`WebSite`", nullable = true, length = 2147483647)
