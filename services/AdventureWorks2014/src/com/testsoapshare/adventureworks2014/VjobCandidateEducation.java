...
public class VjobCandidateEducation implements Serializable {
    ...
    private Timestamp edu_startDate;
    private Timestamp edu_endDate;
    ...
    public Timestamp getEdu_startDate() {
        return this.edu_startDate;
    }

    public void setEdu_startDate(Timestamp edu_startDate) {
        this.edu_startDate = edu_startDate;
    }

    @Id
    @Column(name = "`Edu.EndDate`", nullable = true)
    public Timestamp getEdu_endDate() {
        return this.edu_endDate;
    }

    public void setEdu_endDate(Timestamp edu_endDate) {
