...
public class VjobCandidateEducation implements Serializable {
    ...
    @Id
    @Column(name = "`Edu.Level`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Edu.Degree`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Edu.Major`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Edu.Minor`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Edu.GPA`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Edu.GPAScale`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Edu.School`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Edu.Loc.CountryRegion`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Edu.Loc.State`", nullable = true, length = 255)
    ...
    @Id
    @Column(name = "`Edu.Loc.City`", nullable = true, length = 255)
