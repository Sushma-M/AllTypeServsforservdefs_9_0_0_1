...
public class QueryExecutionController {
    ...
    @ApiOperation(value = "Returns downloadable file for query queryvar")
    @RequestMapping(value = "/queries/queryvar/export/{exportType}", method = RequestMethod.GET, produces = "application/octet-stream")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Downloadable exportQueryvar(@PathVariable("exportType") ExportType exportType, Pageable pageable, HttpServletRequest _request) {
        LOGGER.debug("Exporting named query: queryvar");

        return queryService.exportQueryvar(exportType, pageable);
    }
