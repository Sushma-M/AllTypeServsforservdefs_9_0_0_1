...
public class HrdbQueryExecutorServiceImpl implements HrdbQueryExecutorService {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
    @Override
    public Downloadable exportQueryvar(ExportType exportType, Pageable pageable) {
        Map params = new HashMap(0);


        return queryExecutor.exportNamedQueryData("queryvar", params, exportType, QueryvarResponse.class, pageable);
    }
